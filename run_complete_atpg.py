"""
PODEM ATPG — Complete Corrected Implementation for ISCAS'85 Benchmark Circuits
==============================================================================
Supports: c17, c432, c499
Logic values: 0, 1, X (unknown), D (fault=1, good=0), B (D-bar: fault=0, good=1)

Algorithm Reference:
  Goel, P. (1981). "An Implicit Enumeration Algorithm to Generate Tests for
  Combinational Logic Circuits." IEEE TC, C-30(3), 215–222.
"""
...
if __name__ == '__main__':
    ...
    # This stays outside the loop because we only want ONE summary CSV at the end
    if all_results:
